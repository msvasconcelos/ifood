        ...
        <div class="row">
            <div class="col-xs-12">
              <div class="box box-solid">
                ...
                <a class="pull-left detail-active" href="detail-restaurant.php">
                   Menu
                </a>
                <a class="pull-right" href="detail-restaurant-reviews.php">
                   Avaliações
                </a>
              </div>
              </div>
              ...
              <div class="box box-solid">
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    ...
                    <a href="order.php" class="btn btn-success"><i class="fa fa-credit-card"></i> Fechar Pedido</a>
                  </div>
                </div>
            </div>
            <!-- FIM DO CARRINHO -->
